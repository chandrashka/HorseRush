...
namespace Michsky.MUIP
{
    public class ContextMenu : Editor
    {
        ...
        private static void CreateButton(string resourcePath)
        {
            try
            {
                GetObjectPath();
